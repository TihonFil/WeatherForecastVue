...
const getTimeFromWeatherInfo = (field) => {
  return computed(() => {
    return getTime(props.weatherInfo?.sys?.[field] + timeZone.value);
  });
};

const sunriseTime = getTimeFromWeatherInfo('sunrise');
const sunsetTime = getTimeFromWeatherInfo('sunset');
...
<template>
  <div class="section highlights">
    <div class="title">
      Основная информация на сегодня
    </div>
